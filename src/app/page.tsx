  ...
  return (
    <>
      <div className="flex flex-col w-full items-start gap-32">
        <div className="top-buttons-container w-full flex justify-end items-center gap-4">
          <button className="flex items-center justify-center rounded-[50px] py-[12px] px-[16px] bg-white shadow-[5px_5px_10px_0px_#FE46003D,-5px_-5px_10px_0px_#FAFBFFAD] gap-2">
