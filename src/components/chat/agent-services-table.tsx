      ...
      <table className="min-w-full text-[15px]">
        <thead>
          <tr className="bg-white">
            <th className="border border-[#E5E7EB] pl-6 pr-2 py-2 text-left font-semibold text-[#FF4D29]">Tasks</th>
            <th className="border border-[#E5E7EB] px-2 py-2 text-left font-medium text-[#8F95B2]">Credits</th>
            <th className="border border-[#E5E7EB] px-2 py-2 text-left font-medium text-[#8F95B2]">Actions</th>
          </tr>
        </thead>
        <tbody>
          {services?.map((service, idx) => (
            ...
            >
              <td className="border border-[#E5E7EB] pl-6 pr-2 py-4 font-bold text-[#FF4D29] align-middle whitespace-nowrap">{service.name}</td>
              <td className="border border-[#E5E7EB] px-2 py-4 align-middle whitespace-nowrap">
