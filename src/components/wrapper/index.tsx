...
const Wrapper: FC<WrapperProps> = ({ children }) => {
  ...
  // Show login modal only if user is not authenticated with Supabase
  const shouldShowLoginModal = !isLoading && state.user === null && pathname !== '/register-user';
  ...
  return (
    <>
      ...
      {/* Welcome Modal - Supabase Authentication */}
      <Modal isOpen={shouldShowLoginModal} overlayClassName="bg-black/90">
        <div className="p-12 relative overflow-hidden w-[600px] h-[400px] flex flex-col items-center justify-between">
          <img
            className="absolute top-0 left-0 object-cover w-full h-full z-[-1]"
            alt="modal-bg"
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-gray-500 mt-2 text-center">
              You'll be able to connect any wallet after signing in
            </p>
          </div>
          <button
          ...
          >
            <img src="/assets/connect-wallet-icon.svg" alt="sign-in" />
